...
4. Participants can you any set of tools, software and programing languages that they are comfortable with.
5. Participants are allowed to use external assets, as long as they are publically available, free to use and free to share. **ILLEGAL EXPLOITATION OF OTHERS’ IP WILL NOT BE TOLERATED!**
6. Sources for all external assets must be mentioned, along with any LICENSE they use.
7. Created games are strictly **NOT** allowed to contain sexual content, strong & vulgar language, excessive violence and gore. Mild levels of violence and blood are allowed.
